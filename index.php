...
<body style="background: #f9f9f9">
			...
			<div class="col-lg-6 offset-lg-3 col-md-12 mb-4">
				<div class="card card-body shadow-sm mb-4">
					...
					if (isset($_POST['submit']))
					{
						...
						if (!empty($filegambar))
						{
							...
							{
								if (in_array($ekstensifile, $jenisfile) && ($ukuranfile <= 9000000))
								{
							...
							{
								echo '<script>';
								echo 'swal("Error!", "Ukuran file tidak boleh lebih dari 9MB", "error");';
								echo '</script>';
							}
						}
						else
					...
					<div class="mb-4 font-weight-light">
						<h5 class="font-weight-light">IT FAST Twibbon Generator</h5>
						<span>test</span>
				...
				<div class="card card-body shadow-sm">
					<div class="font-weight-light">
						IG:
						<a href="https://www.instagram.com/fastupb" title="Women for Indonesia">
							@fastupb
						</a>
					</div>
				</div>
	...
	<a href="#" title="">
		<center>
			<img src="#" alt="" class="img-fluid mb-5" width="150">
		</center>
	</a>
	...
	<script>
		...
		document.getElementById('download').addEventListener('click', function() {
			downloadCanvas(this, 'canvas', 'fastupb-twibbon.png');
		}, false);
